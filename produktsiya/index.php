...
$APPLICATION->SetPageProperty("description", "На нашем сайте вы можете ознакомиться с продукцией выпускаемой Императорским Тульским оружейным заводом. Ружья и карабины, крупнокалиберные и мелкокалиберные, нарезные и гладкоствольные.");
$APPLICATION->SetPageProperty("title", "Оружие Тульского оружейного завода - официальный сайт с продукцией");
$APPLICATION->SetTitle("Продукция");
?>
<?$APPLICATION->IncludeComponent(
	"bitrix:catalog",
	"production-withoutbtn",
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array("URLBUY","VIDEO","CHARS",""),
