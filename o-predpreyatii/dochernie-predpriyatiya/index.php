...
$APPLICATION->SetPageProperty("description", "Дочерние предприятия Императорского Тульского оружейного завода.");
...
<?$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "RCM_TYPE" => "personal",
        "SECTION_CODE" => "/o-predpreyatii/dochernie-predpriyatiya/",
        "SECTION_ID" => "12",
        "SECTION_ID_VARIABLE" => "SECTION_ID",
        "SECTION_URL" => "/o-predpreyatii/dochernie-predpriyatiya/",
