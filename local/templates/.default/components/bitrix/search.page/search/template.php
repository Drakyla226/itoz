...
<?else:?>
	<input type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" id="search-enter" class="search__enter _inner" placeholder="Введите запрос">
...
<?endif;?>
	<!-- <input type="submit" value="<?=GetMessage("SEARCH_GO")?>" class="search-form__submit"/> -->
...
<?else:?>
	<p class="blue_note"><?ShowNote(GetMessage("SEARCH_NOTHING_TO_FOUND"));?></p>
<?endif;?>
</div>