...
//var_dump(print_r($arResult));
$sectId = getIdByCode($arResult["VARIABLES"]["SECTION_CODE_PATH"],$arParams['IBLOCK_ID'],'IBLOCK_SECTION');
$template = ($sectId == 2) ? 'production' : 'production-withoutbtn';
