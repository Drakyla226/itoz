...
<div class="feedback__button _button">
 <span class="right-arrow">Узнать больше</span>
</div>
<!--
<?if ($arResult['PROPERTIES']['URLBUY']['VALUE']) {?>
<a class="products-page-url" href="https://tozarms.com/catalog/<?=$arResult['PROPERTIES']['URLBUY']['VALUE']?>">Купить оружие</a
<?}?>
-->
	<div class="nav_knop">
...
<div class="modal__feedback">
	 <?$APPLICATION->IncludeComponent("bitrix:form.result.new", "feedback_pokupka", array(
	"AJAX_MODE" => "Y",
