...
*/?></div>
				<div class="footer-posters-line _03"><a href="/upload/doc/paotoz05.pdf" target="_blank"><img src="/local/templates/index/img/05.png" alt="Горячая линия по противодействию коррупции ПАО «Тульский оружейный завод»"></a></div>
...
*/?></div>
			...
			<div class="footer__signature clear">
				<div class="footer-signature__company">© 1712-<?=date("Y");?> «Тульский оружейный завод»</div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-117769036-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-117769036-1');
</script>
